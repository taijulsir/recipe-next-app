...
const Navbar = () => {
    return (
        <div>
            <div>
                <header className='border-b py-4 px-4 sm:px-10 bg-slate-950 font-[sans-serif] min-h-[70px]'>
                    <div className='flex flex-wrap items-center gap-x-2 max-lg:gap-y-6'>
                        <div className="flex items-center">
                            ...
                            <p className=" text-slate-500 font-bold">Recipefy</p>
                        </div>
                        ...
                        <ul id="collapseMenu"
                            ...
                            <Link href={"/"} className='max-lg:border-b max-lg:py-2 px-3'>
                                <button
                                    className='lg:hover:text-amber-400
                                     text-white block font-semibold text-[15px]'>Home</button>
                            </Link>
                            <Link href={"/createRecipe"} className='max-lg:border-b max-lg:py-2 px-3'>
                                <button
                                    className='lg:hover:text-amber-400
                                     text-white block font-semibold text-[15px]'>Create Recipe</button>
                            </Link>
                            <Link href={"/manageRecipe"} className='max-lg:border-b max-lg:py-2 px-3'>
                                <button
                                    className='lg:hover:text-amber-400
                                     text-white block font-semibold text-[15px]'>Manage Recipe</button>
                            </Link>
                        </ul>
                        <div className='flex items-center lg:ml-auto max-lg:w-full'>
                            ...
                            <div >
                               <button className=" bg-amber-400 px-5 py-4 rounded">
