    ...
    return (
        <div>
             <form className="space-y-4 font-[sans-serif] max-w-4xl mx-auto mt-20">
                <h1 className="text-3xl font-bold "> Update Food Recipe</h1>
                ...
                <button type="button"
                    className="!mt-8 w-full px-4 py-2.5 mx-auto block text-sm font-semibold bg-blue-500 text-white rounded hover:bg-blue-600">Update Recipe</button>
            </form>
        </div>
    );
};
